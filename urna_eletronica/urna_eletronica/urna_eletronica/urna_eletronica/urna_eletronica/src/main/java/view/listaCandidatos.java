...
public class listaCandidatos extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(listaCandidatos.class.getName());
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Candidatos.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new listaCandidatos().setVisible(true));
    }
